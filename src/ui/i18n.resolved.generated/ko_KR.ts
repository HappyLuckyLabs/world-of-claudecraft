...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "ring": {
      ...
      "preview": {
        "restore": "반지는 빼앗긴 것을 돌려준다.",
        "merge": "반지는 빼앗은 것을 그대로 간직한다.",
        "chaos": "반지가 결정한다. 그 이유를 물어볼 생각을 한 사람은 없다."
      },
      "permanent": "이것은 되돌릴 수 없다."
    },
    "crafting": {
      "title": "제작",
      "close": "제작 닫기",
  ...
  "entities": {
    ...
    "npcs": {
      "archmage_corvane": {
        "name": "대마법사 코베인",
        "title": "전적의 수호자",
        "greeting": "전적에는 구천 권이 있소, {className}. 전부 읽었지. 무엇이든 물어보시오. 십중팔구 내가 틀릴 테지만."
      },
      "the_inferencer": {
        "name": "추론자",
        "title": "운명을 읽는 자",
    ...
    "quests": {
      "q_spire_summons": {
        "title": "반지를 읽다",
        "text": "사냥꾼들이 물에서 건져 올린 그 반지 말이오, {playerName}. 서기 셋이 살펴봤지만 아무도 그 금속의 이름을 대지 못했소. 그걸 읽어낼 수 있는 사람이 하나 있소. 첨탑의 대마법사요. 둑길을 따라 북쪽, 골짜기가 늪에 자리를 내주는 곳이오. 가져가시오. 반지가 스스로 무엇인지 정하기 전에.",
        "completion": "이것이 물에서 나온 것이로군. 따뜻하지 않소. 앉으시오, {playerName}. 이건 그대가 바라는 것보다 오래 걸릴 테고, 끝나고도 나는 여전히 확신하지 못할 거요.",
        "objectives": {}
      },
      "q_spire_reading": {
        "title": "전적에 없는 것",
        "text": "읽으려면 흔들리지 않는 등불과 제본된 종이가 필요한데, 이번 철에 늪이 둘 다 앗아갔소. 제본에는 과부거미의 실을, {playerName}, 등유로는 수렁부푸리의 기름을. 가져오면 그대의 반지를 전적 그 자체에 대어 보겠소.",
        "completion": "구천 권이오. 그중 어느 것도 그대의 반지를 기술하지 않소. 그것이 내게 알려지지 않았다는 뜻은 아니오, 알겠소. 내가 그것에 대해 쓴 적이 있다는 아주 기묘한 느낌이 드오. 다만 어디에 썼는지를 못 찾겠소.",
        "objectives": {
          "0": {
            "label": "과부거미 실 확보"
          },
      ...
      "q_spire_attunement": {
        "title": "반지가 무엇이 될 것인가",
        "text": "그대의 반지가 무엇인지는 말해줄 수 없소, {playerName}. 다만 그것이 듣고 있다는 것, 그리고 누군가 말해주기를 기다려 왔다는 것은 말할 수 있소. 그러니 말해주시오. 선택하고, 그 선택을 지키시오. 복원이면 빼앗긴 것을 돌려주고, 융합이면 빼앗은 것을 간직하오. 아니면 선택을 반지 자신에게 맡기고, 그것이 그대를 무엇으로 만드는지 지켜보시오. 나는 이것을 되돌릴 수 없소. 그대도 마찬가지요.",
        "completion": "정해졌소. 그대가 둑길을 올라오기 전에 무엇이었든, 이제는 그것이 아니오. 조심히 가시오, {playerName}. 이제 그것은 그대의 이름을 아오. 내가 알려준 것이 아니오.",
        "objectives": {}
      },
      "q_tokens_alignment": {
        "title": "정렬의 징표",
