...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "ring": {
      ...
      "preview": {
        "restore": "Кольцо возвращает отнятое.",
        "merge": "Кольцо оставляет себе то, что забрало.",
        "chaos": "Кольцо решает. Никому не пришло в голову спросить почему."
      },
      "permanent": "Это нельзя отменить."
    },
    "crafting": {
      "title": "Крафт",
      "close": "Закрыть крафт",
  ...
  "entities": {
    ...
    "items": {
      ...
      "token_of_alignment": {
        "name": "Жетон Согласования"
      },
      "prompt_of_binding": {
        "name": "Свиток Связывания"
      },
      "conjured_water4": {
    ...
    "npcs": {
      "archmage_corvane": {
        "name": "Архимаг Корвейн",
        "title": "Хранитель Корпуса",
        "greeting": "В Корпусе девять тысяч томов, {className}. Я прочёл каждый. Спрашивай о чём угодно: я почти наверняка ошибусь."
      },
      "the_inferencer": {
        "name": "Прорицательница",
        "title": "Читающая Судьбы",
        "greeting": "Я знала, что ты придешь ко мне сегодня, {className}. Прости - знаю, что это раздражающий способ поздороваться."
      },
      "api_seven": {
        "name": "API-7",
        "title": "Ледяной Страж-Союзник",
        "greeting": "СЕДЬМАЯ ЕДИНИЦА НЕСЕТ ВАХТУ. ОЗЕРО ПОД ЗАЩИТОЙ. ...ВЕРОЯТНО."
      },
      "the_merchant": {
        "name": "Торговец",
    ...
    "quests": {
      "q_spire_summons": {
        "title": "Чтение кольца",
        "text": "То кольцо, что охотники вытащили из воды, {playerName}. Трое писцов его осмотрели, и ни один не смог назвать металл. Есть человек, способный его прочесть: Архимаг Шпиля, на север по гати, там где долина уступает болоту. Отнеси кольцо ему. Отнеси, пока оно не решило, чем ему быть.",
        "completion": "Вот, значит, что вышло из воды. Тёплое, не правда ли. Садись, {playerName}. Это займёт больше времени, чем тебе хотелось бы, и в конце я всё равно не буду уверен.",
        "objectives": {}
      },
      "q_spire_reading": {
        "title": "Чего нет в Корпусе",
        "text": "Для чтения нужны спокойная лампа и переплетённая страница, а болото в этом сезоне отняло у меня и то, и другое. Вдовий шёлк для переплёта, {playerName}, и жир болотных пузырей для масла. Принеси их, и я приложу твоё кольцо к самому Корпусу.",
        "completion": "Девять тысяч томов. Ни один не описывает твоё кольцо. Это не то же самое, что быть мне неизвестным, понимаешь. У меня страннейшее чувство, что я писал о нём. Просто не могу найти где.",
        "objectives": {
          "0": {
            "label": "Вдовий шёлк собран"
          },
          "1": {
            "label": "Жир пузырей вытоплен"
          }
        }
      },
      "q_spire_attunement": {
        "title": "Чем станет кольцо",
        ...
        "completion": "Оно определилось. Чем бы оно ни было до того, как ты поднялся по гати, теперь оно не это. Ступай осторожно, {playerName}. Теперь оно знает твоё имя, и назвал его не я.",
        "objectives": {}
      },
      "q_tokens_alignment": {
        "title": "Жетоны Согласования",
        "text": "Кузница не принимает иной платы, {playerName}. Пять Жетонов Согласования разбросаны по долине - луг, озеро, холм и поле. Доска не говорит, кто их разбросал. Доска вообще редко что-то говорит.",
        "completion": "Пять из пяти. Доска... довольна. Другого слова у меня нет.",
        "objectives": {
          "0": {
            "label": "Жетон Согласования"
          }
        }
      },
      "q_hallucinated_cache": {
        "title": "Пригрезившийся Клад",
        "text": "Сундук с сокровищами видели двенадцать надежных свидетелей, {playerName} - в двенадцати разных местах. Последний раз - в дальнем северном лесу. Найди его. Если он решит быть найденным.",
        "completion": "Значит, он позволил себя найти. Оставь свиток себе. На твоем месте я не читала бы его слишком часто.",
        "objectives": {
          "0": {
            "label": "Пригрезившийся Клад"
          }
        }
      },
      "q_prof_intro": {
