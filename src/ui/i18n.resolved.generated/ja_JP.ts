  ...
  "entities": {
    ...
    "npcs": {
      "archmage_corvane": {
        "name": "大魔道士コルヴェイン",
        "title": "典籍の守り手",
        "greeting": "典籍は九千巻ある、{className}。すべて読んだ。何でも訊くがいい。おそらく私は間違える。"
      },
      "the_inferencer": {
        "name": "推察師",
        "title": "運命を読む者",
    ...
    "quests": {
      "q_spire_summons": {
        "title": "指輪を読む",
        "text": "狩人たちが水から引き上げたあの指輪です、{playerName}。三人の書記が見ましたが、誰も金属の名を言えません。あれを読める者が一人います。尖塔の大魔道士、堤道を北へ、谷が沼へと変わるあたりです。持って行きなさい。指輪が自分を何と決める前に。",
        "completion": "これが水から出たものか。温かいだろう。座りなさい、{playerName}。望むより長くかかる。そして終わってもなお、私は確信を持てまい。",
        "objectives": {}
      },
      "q_spire_reading": {
        "title": "典籍に無いもの",
        "text": "読むには静かな灯と綴じた紙がいる。この季節、沼はその両方を奪っていった。綴じには寡婦の糸を、{playerName}、灯油には沼ぶくれの脂を。持って来なさい。そうすれば君の指輪を典籍そのものと突き合わせよう。",
        "completion": "九千巻。どの一巻も君の指輪を記していない。私が知らぬという意味ではない、いいかね。私はそれについて書いた気がしてならない。ただ、どこに書いたのか見つからないのだ。",
        "objectives": {
          "0": {
            "label": "寡婦の糸を採取"
          },
