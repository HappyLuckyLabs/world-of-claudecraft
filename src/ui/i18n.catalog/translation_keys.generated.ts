...
export type TranslationKeyFlat =
  ...
  | 'entities.items.prompt_of_binding.name'
  ...
  | 'entities.items.token_of_alignment.name'
  ...
  | 'entities.npcs.api_seven.name'
  | 'entities.npcs.api_seven.title'
  ...
  | 'entities.npcs.archmage_corvane.name'
  | 'entities.npcs.archmage_corvane.title'
  ...
  | 'entities.npcs.the_inferencer.name'
  | 'entities.npcs.the_inferencer.title'
  ...
  | 'entities.quests.q_hallucinated_cache.objectives.0.label'
  | 'entities.quests.q_hallucinated_cache.text'
  | 'entities.quests.q_hallucinated_cache.title'
  ...
  | 'entities.quests.q_spire_attunement.title'
  | 'entities.quests.q_spire_reading.completion'
  | 'entities.quests.q_spire_reading.objectives.0.label'
  | 'entities.quests.q_spire_reading.objectives.1.label'
  | 'entities.quests.q_spire_reading.text'
  | 'entities.quests.q_spire_reading.title'
  | 'entities.quests.q_spire_summons.completion'
  | 'entities.quests.q_spire_summons.text'
  | 'entities.quests.q_spire_summons.title'
  ...
  | 'entities.quests.q_tokens_alignment.objectives.0.label'
  | 'entities.quests.q_tokens_alignment.text'
  | 'entities.quests.q_tokens_alignment.title'
  ...
  | 'hudChrome.ring.path.chaos'
  | 'hudChrome.ring.path.merge'
  | 'hudChrome.ring.path.restore'
  | 'hudChrome.ring.permanent'
  | 'hudChrome.ring.preview.chaos'
  | 'hudChrome.ring.preview.merge'
  | 'hudChrome.ring.preview.restore'
