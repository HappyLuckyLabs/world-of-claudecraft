...
export const shellStrings = {
  en: {
    seo: {
      ...
      description:
        'Embark on an epic adventure in Claude of the Rings, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!',
      genre: 'MMORPG',
  ...
  es: {
    seo: {
      title: 'Claude of the Rings: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en Claude of the Rings, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto de Claude of the Rings en GitHub',
      discordCommunity: 'Unirse a la comunidad de Claude of the Rings en Discord',
      donateProject: 'Donar para apoyar Claude of the Rings',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abre Claude of the Rings desde el nuevo icono de la pantalla de inicio.',
      ...
      androidOpenStep: 'Abre Claude of the Rings desde el nuevo icono.',
    ...
    serverUnavailable: {
      title: 'Claude of the Rings - Reino no disponible',
      logoAlt: 'Claude of the Rings',
  ...
  es_ES: {
    seo: {
      title: 'Claude of the Rings: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en Claude of the Rings, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
      genre: 'MMORPG',
      playMode: 'Multijugador',
      applicationCategory: 'Juego',
      operatingSystem: 'Navegador web',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto Claude of the Rings en GitHub',
      discordCommunity: 'Unirse a la comunidad de Claude of the Rings en Discord',
      donateProject: 'Donar para apoyar Claude of the Rings',
    },
    loading: {
  ...
  fr_FR: {
    seo: {
      title: 'Claude of the Rings: MMO web de style classique',
      description:
        'Partez pour une aventure épique dans Claude of the Rings, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Ouvrir le projet Claude of the Rings sur GitHub',
      discordCommunity: 'Rejoindre la communauté Claude of the Rings sur Discord',
      donateProject: 'Faire un don pour soutenir Claude of the Rings',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez Claude of the Rings depuis la nouvelle icône de l'écran d'accueil.",
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Ouvrez Claude of the Rings depuis la nouvelle icône.',
    ...
    serverUnavailable: {
      title: 'Claude of the Rings - Royaume indisponible',
      logoAlt: 'Claude of the Rings',
  ...
  fr_CA: {
    seo: {
      title: 'Claude of the Rings: MMO Web de style classique',
      description:
        "Partez à l'aventure dans Claude of the Rings, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: 'MMORPG',
      playMode: 'Multijoueur',
      applicationCategory: 'Jeu',
      operatingSystem: 'Navigateur Web',
  ...
  en_CA: {
    seo: {
      title: 'Claude of the Rings: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in Claude of the Rings, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
    ...
    serverUnavailable: {
      title: 'Claude of the Rings - Realm Unavailable',
      logoAlt: 'Claude of the Rings',
  ...
  it_IT: {
    seo: {
      title: 'Claude of the Rings: MMO web in stile classico',
      description:
        "Parti per un'avventura epica in Claude of the Rings, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Apri il progetto Claude of the Rings su GitHub',
      discordCommunity: 'Entra nella community Discord di Claude of the Rings',
      donateProject: 'Fai una donazione per sostenere Claude of the Rings',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Apri Claude of the Rings dalla nuova icona nella schermata Home.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Apri Claude of the Rings dalla nuova icona.',
    ...
    serverUnavailable: {
      title: 'Claude of the Rings - Reame non disponibile',
      logoAlt: 'Claude of the Rings',
  ...
  de_DE: {
    seo: {
      title: 'Claude of the Rings: Klassisches Web-MMO',
      description:
        'Begib dich in Claude of the Rings auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Claude of the Rings-Projekt auf GitHub öffnen',
      discordCommunity: 'Der Claude of the Rings-Community auf Discord beitreten',
      donateProject: 'Spenden, um Claude of the Rings zu unterstützen',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Öffne Claude of the Rings über das neue Symbol auf dem Home-Bildschirm.',
      ...
      androidOpenStep: 'Öffne Claude of the Rings über das neue Symbol.',
    ...
    serverUnavailable: {
      title: 'Claude of the Rings - Realm nicht verfügbar',
      logoAlt: 'Claude of the Rings',
  ...
  zh_CN: {
    seo: {
      title: 'Claude of the Rings：经典风格网页 MMO',
      description:
        '在 Claude of the Rings 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
      genre: 'MMORPG',
      playMode: '多人游戏',
    ...
    a11y: {
      ...
      githubProject: '打开 Claude of the Rings 的 GitHub 项目',
      discordCommunity: '加入 Claude of the Rings 的 Discord 社区',
      donateProject: '捐赠支持 Claude of the Rings',
    },
    loading: {
      world: '正在加载世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '从新的主屏幕图标打开 Claude of the Rings。',
  ...
  zh_TW: {
    seo: {
      title: 'Claude of the Rings：經典風格網頁 MMO',
      description:
        '在 Claude of the Rings 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
      genre: 'MMORPG',
      playMode: '多人遊戲',
    ...
    a11y: {
      ...
      characterActions: '角色操作',
      githubProject: '開啟 Claude of the Rings 的 GitHub 專案',
      discordCommunity: '加入 Claude of the Rings 的 Discord 社群',
      donateProject: '捐贈支持 Claude of the Rings',
    },
    loading: {
      world: '正在載入世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '從新的主畫面圖示開啟 Claude of the Rings。',
  ...
  ko_KR: {
    seo: {
      title: 'Claude of the Rings: 클래식 스타일 웹 MMO',
      description:
        '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Claude of the Rings에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
      genre: 'MMORPG',
      playMode: '멀티플레이어',
    ...
    a11y: {
      ...
      githubProject: 'GitHub에서 Claude of the Rings 프로젝트 열기',
      discordCommunity: 'Claude of the Rings Discord 커뮤니티 참여',
      donateProject: 'Claude of the Rings 후원하기',
    },
    loading: {
      world: '세계 불러오는 중...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '새 홈 화면 아이콘에서 Claude of the Rings를 여세요.',
  ...
  ja_JP: {
    seo: {
      title: 'Claude of the Rings: クラシック風Web MMO',
      description:
        'ブラウザで直接遊べるクラシック風マイクロMMO、Claude of the Rings で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。',
      genre: 'MMORPG',
      playMode: 'マルチプレイヤー',
    ...
    a11y: {
      ...
      githubProject: 'GitHubでClaude of the Ringsプロジェクトを開く',
      discordCommunity: 'Claude of the RingsのDiscordコミュニティに参加',
      donateProject: 'Claude of the Ringsを支援するために寄付',
    },
    loading: {
      world: '世界を読み込み中...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '新しいホーム画面アイコンからClaude of the Ringsを開きます。',
  ...
  pt_BR: {
    seo: {
      title: 'Claude of the Rings: MMO web em estilo clássico',
      description:
        'Embarque em uma aventura épica em Claude of the Rings, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir o projeto Claude of the Rings no GitHub',
      discordCommunity: 'Entrar na comunidade Claude of the Rings no Discord',
      donateProject: 'Doar para apoiar Claude of the Rings',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abra Claude of the Rings pelo novo ícone na tela inicial.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Abra Claude of the Rings pelo novo ícone.',
    ...
    serverUnavailable: {
      title: 'Claude of the Rings - Reino indisponível',
      logoAlt: 'Claude of the Rings',
  ...
  ru_RU: {
    seo: {
      title: 'Claude of the Rings: веб-MMO в классическом стиле',
      description:
        'Отправьтесь в эпическое приключение в Claude of the Rings, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Открыть проект Claude of the Rings на GitHub',
      discordCommunity: 'Присоединиться к Discord-сообществу Claude of the Rings',
      donateProject: 'Пожертвовать на поддержку Claude of the Rings',
    },
    loading: {
      world: 'Загрузка мира...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Откройте Claude of the Rings через новый значок на домашнем экране.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Откройте Claude of the Rings через новый значок.',
    ...
    serverUnavailable: {
      title: 'Claude of the Rings - мир недоступен',
      logoAlt: 'Claude of the Rings',
