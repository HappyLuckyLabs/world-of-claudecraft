...
export const pl_PL: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting':
    'Wiedzialam, ze dzis przyjdziesz, {className}. Wybacz - wiem, ze to irytujacy sposob powitania.',
  ...
  'entities.npcs.api_seven.greeting':
    'JEDNOSTKA SIODMA TRZYMA WARTE. JEZIORO JEST CHRONIONE. ...PRAWDOPODOBNIE.',
  'entities.quests.q_tokens_alignment.title': 'Znaki Wyrownania',
  'entities.quests.q_tokens_alignment.text':
    'Kuznia nie przyjmuje innej waluty, {playerName}. Piec Znakow Wyrownania lezy rozrzuconych po dolinie - laka, jezioro, wzgorze i pole. Tablica nie mowi, kto je rozrzucil. Tablica rzadko cokolwiek mowi.',
  'entities.quests.q_tokens_alignment.completion':
    'Piec z pieciu. Tablica jest... usatysfakcjonowana. Nie mam na to innego slowa.',
  ...
  'entities.quests.q_hallucinated_cache.text':
    'Skrzynie ze skarbem widzialo tuzin wiarygodnych swiadkow, {playerName} - w tuzinie roznych miejsc. Ostatnio w dalekich polnocnych lasach. Znajdz ja. Jesli zdecyduje sie dac znalezc.',
