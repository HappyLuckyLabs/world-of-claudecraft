...
export const cs_CZ: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting':
    'Vedela jsem, ze dnes prijdes, {className}. Promin - vim, ze je to otravny zpusob pozdravu.',
  ...
  'entities.npcs.api_seven.greeting':
    'JEDNOTKA SEDM DRZI HLIDKU. JEZERO JE CHRANENO. ...PRAVDEPODOBNE.',
  'entities.quests.q_tokens_alignment.title': 'Znamky Souladu',
  'entities.quests.q_tokens_alignment.text':
    'Kovarna neprijima jinou menu, {playerName}. Pet Znamek Souladu lezi rozeseto po udoli - louka, jezero, kopec i pole. Tabule nerika, kdo je rozesel. Tabule toho rika malo.',
  'entities.quests.q_tokens_alignment.completion':
    'Pet z peti. Tabule je... spokojena. Jine slovo pro to nemam.',
  ...
  'entities.quests.q_hallucinated_cache.text':
    'Truhlu s pokladem videlo tucet spolehlivych svedku, {playerName} - na tuctu ruznych mist. Naposledy v dalekem severnim lese. Najdi ji. Pokud se rozhodne nechat najit.',
