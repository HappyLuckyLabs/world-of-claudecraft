...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.options.graphicsPresetInsane': 'Экстремальное',
  ...
  'hud.options.surfaceDetail': 'Детализация поверхностей',
  'hud.options.surfaceDetailBasic': 'Базовая',
  'hud.options.surfaceDetailFull': 'Полная',
  ...
  'entities.items.basin_stalkers_tunic.name': 'Туника лазутчика Котловины',
  ...
  'entities.items.fanglords_beastspear.name': 'Звериное копье Повелителя клыков',
  'entities.items.bloodmane_warleggings.name': 'Боевые поножи Кровавой Гривы',
  'entities.items.vineclaw_stalking_breeches.name': 'Штаны лазутчика Лозокогтя',
  'entities.items.sunbone_ritual_sarong.name': 'Ритуальный саронг Солнечной Кости',
  ...
  'entities.items.token_of_alignment.name': 'Жетон Согласования',
  'entities.items.prompt_of_binding.name': 'Свиток Связывания',
  'entities.npcs.the_inferencer.name': 'Прорицательница',
  'entities.npcs.the_inferencer.title': 'Читающая Судьбы',
  'entities.npcs.the_inferencer.greeting': 'Я знала, что ты придешь ко мне сегодня, {className}. Прости - знаю, что это раздражающий способ поздороваться.',
  'entities.npcs.api_seven.name': 'API-7',
  'entities.npcs.api_seven.title': 'Ледяной Страж-Союзник',
  'entities.npcs.api_seven.greeting': 'СЕДЬМАЯ ЕДИНИЦА НЕСЕТ ВАХТУ. ОЗЕРО ПОД ЗАЩИТОЙ. ...ВЕРОЯТНО.',
  'entities.quests.q_tokens_alignment.title': 'Жетоны Согласования',
  'entities.quests.q_tokens_alignment.text': 'Кузница не принимает иной платы, {playerName}. Пять Жетонов Согласования разбросаны по долине - луг, озеро, холм и поле. Доска не говорит, кто их разбросал. Доска вообще редко что-то говорит.',
  'entities.quests.q_tokens_alignment.completion': 'Пять из пяти. Доска... довольна. Другого слова у меня нет.',
  'entities.quests.q_tokens_alignment.objectives.0.label': 'Жетон Согласования',
  'entities.quests.q_hallucinated_cache.title': 'Пригрезившийся Клад',
  'entities.quests.q_hallucinated_cache.text': 'Сундук с сокровищами видели двенадцать надежных свидетелей, {playerName} - в двенадцати разных местах. Последний раз - в дальнем северном лесу. Найди его. Если он решит быть найденным.',
  'entities.quests.q_hallucinated_cache.completion': 'Значит, он позволил себя найти. Оставь свиток себе. На твоем месте я не читала бы его слишком часто.',
  'entities.quests.q_hallucinated_cache.objectives.0.label': 'Пригрезившийся Клад',
  'entities.npcs.archmage_corvane.name': 'Архимаг Корвейн',
  'entities.npcs.archmage_corvane.title': 'Хранитель Корпуса',
  'entities.npcs.archmage_corvane.greeting': 'В Корпусе девять тысяч томов, {className}. Я прочёл каждый. Спрашивай о чём угодно: я почти наверняка ошибусь.',
  'entities.quests.q_spire_summons.title': 'Чтение кольца',
  'entities.quests.q_spire_summons.text': 'То кольцо, что охотники вытащили из воды, {playerName}. Трое писцов его осмотрели, и ни один не смог назвать металл. Есть человек, способный его прочесть: Архимаг Шпиля, на север по гати, там где долина уступает болоту. Отнеси кольцо ему. Отнеси, пока оно не решило, чем ему быть.',
  'entities.quests.q_spire_summons.completion': 'Вот, значит, что вышло из воды. Тёплое, не правда ли. Садись, {playerName}. Это займёт больше времени, чем тебе хотелось бы, и в конце я всё равно не буду уверен.',
  'entities.quests.q_spire_reading.title': 'Чего нет в Корпусе',
  'entities.quests.q_spire_reading.text': 'Для чтения нужны спокойная лампа и переплетённая страница, а болото в этом сезоне отняло у меня и то, и другое. Вдовий шёлк для переплёта, {playerName}, и жир болотных пузырей для масла. Принеси их, и я приложу твоё кольцо к самому Корпусу.',
  ...
  'hudChrome.ring.path.restore': 'Восстановление',
  'hudChrome.ring.path.merge': 'Слияние',
  'hudChrome.ring.path.chaos': 'Хаос',
  'hudChrome.ring.preview.restore': 'Кольцо возвращает отнятое.',
  'hudChrome.ring.preview.merge': 'Кольцо оставляет себе то, что забрало.',
  'hudChrome.ring.preview.chaos': 'Кольцо решает. Никому не пришло в голову спросить почему.',
  'hudChrome.ring.permanent': 'Это нельзя отменить.',
  'entities.quests.q_spire_attunement.title': 'Чем станет кольцо',
  'entities.quests.q_spire_attunement.text': 'Я не могу сказать тебе, что такое твоё кольцо, {playerName}. Я могу сказать, что оно слушает и что оно ждало, когда ему скажут. Так скажи ему. Выбери и держись выбора: восстановление, и оно возвращает отнятое; слияние, и оно оставляет себе то, что забрало; или предоставь выбор самому кольцу и посмотри, что оно сделает из тебя. Я не смогу это отменить. И ты тоже.',
  'entities.quests.q_spire_attunement.completion': 'Оно определилось. Чем бы оно ни было до того, как ты поднялся по гати, теперь оно не это. Ступай осторожно, {playerName}. Теперь оно знает твоё имя, и назвал его не я.',
};
