...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting':
    'Eu sabia que voce viria me ver hoje, {className}. Desculpe - sei que e um jeito irritante de dizer ola.',
  'entities.npcs.api_seven.name': 'API-7',
  'entities.npcs.api_seven.title': 'Protetor Aliado de Gelo',
  'entities.npcs.api_seven.greeting':
    'A UNIDADE SETE MONTA GUARDA. O LAGO ESTA PROTEGIDO. ...PROVAVELMENTE.',
  'entities.quests.q_tokens_alignment.title': 'Fichas de Alinhamento',
  'entities.quests.q_tokens_alignment.text':
    'A Forja nao aceita outra moeda, {playerName}. Cinco Fichas de Alinhamento estao espalhadas pelo vale - campina, lago, colina e campo. O quadro nao diz quem as espalhou. O quadro raramente diz.',
  'entities.quests.q_tokens_alignment.completion':
    'Cinco de cinco. O quadro esta... satisfeito. Nao tenho outra palavra.',
  ...
  'entities.quests.q_hallucinated_cache.text':
    'Um bau do tesouro foi avistado por uma duzia de testemunhas confiaveis, {playerName} - em uma duzia de lugares diferentes. Nas matas do extremo norte, mais recentemente. Encontre-o. Se ele decidir ser encontrado.',
