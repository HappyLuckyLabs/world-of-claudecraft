...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting':
    '오늘 당신이 올 줄 알고 있었어요, {className}. 미안해요 - 이런 인사가 짜증스럽다는 건 알아요.',
  ...
  'entities.quests.q_tokens_alignment.text':
    '용광로는 다른 화폐를 받지 않아요, {playerName}. 정렬의 징표 다섯 개가 계곡 곳곳에 흩어져 있어요 - 초원, 호수, 언덕, 들판. 게시판은 누가 흩어 놓았는지 말하지 않아요. 게시판은 좀처럼 말하지 않죠.',
  'entities.quests.q_tokens_alignment.completion':
    '다섯 개 전부군요. 게시판이... 만족했어요. 달리 표현할 말이 없네요.',
  ...
  'entities.quests.q_hallucinated_cache.text':
    '믿을 만한 목격자 열두 명이 보물상자를 봤어요, {playerName} - 서로 다른 열두 곳에서요. 가장 최근엔 북쪽 깊은 숲이었죠. 찾아보세요. 상자가 발견되기로 마음먹는다면요.',
