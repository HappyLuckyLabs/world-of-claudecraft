...
export const en_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting': 'I knew you would come to me today, {className}. I am sorry - I know that is an irritating way to say hello.',
  'entities.npcs.api_seven.name': 'API-7',
  'entities.npcs.api_seven.title': 'Ally Protector Ice',
  'entities.npcs.api_seven.greeting': 'UNIT SEVEN STANDS WATCH. THE LAKE IS PROTECTED. ...PROBABLY.',
  'entities.quests.q_tokens_alignment.title': 'Tokens of Alignment',
  'entities.quests.q_tokens_alignment.text': 'The Forge accepts no other currency, {playerName}. Five Tokens of Alignment lie scattered across the valley - meadow, lake, hill and field. The board does not say who scattered them. The board rarely says.',
  'entities.quests.q_tokens_alignment.completion': 'Five of five. The board is... satisfied. That is the only word I have for it.',
  ...
  'entities.quests.q_hallucinated_cache.text': 'A treasure chest has been sighted by a dozen reliable witnesses, {playerName} - in a dozen different places. The far north woods, most recently. Find it. If it decides to be found.',
  'entities.quests.q_hallucinated_cache.completion': 'So it allowed itself to be found. Keep the scroll inside. I would not read it too often, were I you.',
