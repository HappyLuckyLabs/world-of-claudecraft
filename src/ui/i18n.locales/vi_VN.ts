...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  'apiError.epic.account_taken': 'Tài khoản Epic đó đã được liên kết với một tài khoản khác.',
  ...
  'hud.options.surfaceDetailFull': 'Đầy Đủ',
  'hudChrome.auraOverlay.allOff': 'Tắt tất cả',
  'hudChrome.auraOverlay.allOn': 'Bật tất cả',
  'hudChrome.auraOverlay.arcs': 'Vành trăng bên',
  'hudChrome.auraOverlay.color': 'Màu sắc',
  'hudChrome.auraOverlay.crescentBlockSize': 'Kích thước khối vành trăng',
  'hudChrome.auraOverlay.crescentsSpellOrder': 'Vành trăng bên: thứ tự phép',
  'hudChrome.auraOverlay.currentClass': 'Lớp hiện tại: {class}',
  'hudChrome.auraOverlay.done': 'Xong',
  'hudChrome.auraOverlay.enabled': 'Hiện hào quang',
  'hudChrome.auraOverlay.groundRing': 'Vòng mặt đất',
  'hudChrome.auraOverlay.groundRingBlockSize': 'Kích thước khối vòng mặt đất',
  'hudChrome.auraOverlay.groundRingSpellOrder': 'Vòng mặt đất: thứ tự phép',
  'hudChrome.auraOverlay.icon': 'Biểu tượng phép',
  'hudChrome.auraOverlay.iconSize': 'Kích thước biểu tượng',
  'hudChrome.auraOverlay.moveDown': 'Di chuyển xuống',
  'hudChrome.auraOverlay.moveEarlier': 'Di chuyển phép vào trong',
  'hudChrome.auraOverlay.moveLater': 'Di chuyển phép ra ngoài',
  'hudChrome.auraOverlay.moveLeft': 'Di chuyển sang trái',
  'hudChrome.auraOverlay.moveRight': 'Di chuyển sang phải',
  'hudChrome.auraOverlay.moveUp': 'Di chuyển lên',
  ...
  'hudChrome.auraOverlay.procs.enrage': 'Cuồng Loạn: Phẫn Nộ',
  'hudChrome.auraOverlay.procs.heatingUp': 'Đang Nóng Lên',
  ...
  'hudChrome.auraOverlay.selectAura': 'Hào quang',
  'hudChrome.auraOverlay.size': 'Kích thước',
  ...
  'hudChrome.targetAuras.fewerRows': 'Ưu tiên ít hàng hào quang hơn',
  'hudChrome.targetAuras.hideSources': 'Ẩn nguồn hào quang',
  'hudChrome.targetAuras.keybindLabel': 'Buff và Debuff Mục Tiêu',
  'hudChrome.targetAuras.lock': 'Khóa cửa sổ hào quang mục tiêu',
  'hudChrome.targetAuras.moreRows': 'Ưu tiên nhiều hàng hào quang hơn',
  'hudChrome.targetAuras.opacity': 'Độ mờ hào quang: {percent}',
  'hudChrome.targetAuras.ownAura': 'Hào quang của bạn',
  'hudChrome.targetAuras.showSources': 'Hiện nguồn hào quang',
  'hudChrome.targetAuras.title': 'Hào Quang Mục Tiêu',
  'hudChrome.targetAuras.unlock': 'Di chuyển cửa sổ hào quang mục tiêu',
  'hudChrome.targetAuras.visibleRows': 'Số hàng hào quang mong muốn: {count}',
  ...
  'entities.items.basin_stalkers_tunic.name': 'Áo Chẽn Kẻ Rình Rập Vùng Trũng',
  ...
  'hud.combat.floatingEvade': 'Lẩn Tránh',
  ...
  'entities.items.fanglords_beastspear.name': 'Thương Săn Thú Của Lãnh Chúa Nanh',
  'entities.items.bloodmane_warleggings.name': 'Quần Chiến Bờm Máu',
  'entities.items.vineclaw_stalking_breeches.name': 'Quần Rình Rập Vuốt Dây Leo',
  'entities.items.sunbone_ritual_sarong.name': 'Xà Rông Nghi Lễ Xương Mặt Trời',
  ...
  'entities.items.token_of_alignment.name': 'Tin Vat Can Chinh',
  'entities.items.prompt_of_binding.name': 'Cuon Giay Troi Buoc',
  'entities.npcs.the_inferencer.name': 'Nguoi Suy Luan',
  'entities.npcs.the_inferencer.title': 'Nguoi Doc Van Menh',
  'entities.npcs.the_inferencer.greeting': 'Toi biet hom nay ban se den, {className}. Xin loi - toi biet cach chao nay kha kho chiu.',
  'entities.npcs.api_seven.name': 'API-7',
  'entities.npcs.api_seven.title': 'Ho Ve Bang Dong Minh',
  'entities.npcs.api_seven.greeting': 'DON VI BAY DANG CANH GAC. HO NUOC DUOC BAO VE. ...CO LE.',
  'entities.quests.q_tokens_alignment.title': 'Tin Vat Can Chinh',
  'entities.quests.q_tokens_alignment.text': 'Lo Ren khong nhan loai tien nao khac, {playerName}. Nam Tin Vat Can Chinh nam rai rac khap thung lung - dong co, ho, doi va canh dong. Bang tin khong noi ai da rai chung. Bang tin hiem khi noi gi.',
  'entities.quests.q_tokens_alignment.completion': 'Du nam cai. Bang tin... hai long. Toi khong con tu nao khac.',
  'entities.quests.q_tokens_alignment.objectives.0.label': 'Tin Vat Can Chinh',
  'entities.quests.q_hallucinated_cache.title': 'Ruong Bau Ao Giac',
  'entities.quests.q_hallucinated_cache.text': 'Mot ruong bau da duoc muoi hai nhan chung dang tin thay, {playerName} - o muoi hai noi khac nhau. Gan nhat la trong khu rung xa phia bac. Hay tim no. Neu no quyet dinh de duoc tim thay.',
  'entities.quests.q_hallucinated_cache.completion': 'Vay la no da chiu de bi tim thay. Giu lay cuon giay ben trong. Neu la toi, toi se khong doc no qua thuong xuyen.',
  'entities.quests.q_hallucinated_cache.objectives.0.label': 'Ruong Bau Ao Giac',
  'entities.npcs.archmage_corvane.name': 'Dai Phap Su Corvane',
  'entities.npcs.archmage_corvane.title': 'Nguoi Giu Thu Tich',
  'entities.npcs.archmage_corvane.greeting': 'Thu Tich co chin nghin quyen, {className}. Ta da doc het. Hoi gi cung duoc: rat co the ta se tra loi sai.',
  'entities.quests.q_spire_summons.title': 'Doc Chiec Nhan',
  'entities.quests.q_spire_summons.text': 'Chiec nhan ma tho san vot len tu duoi nuoc ay, {playerName}. Ba vien thu lai da xem qua va khong ai goi duoc ten kim loai. Co mot nguoi doc duoc no: Dai Phap Su o Thap Nhon, di ve phia bac theo con duong dap, noi thung lung nhuong cho cho dam lay. Mang no den do. Mang di truoc khi no quyet dinh minh la gi.',
  'entities.quests.q_spire_summons.completion': 'Vay day la thu da tu duoi nuoc len. Am, phai khong. Ngoi xuong di, {playerName}. Viec nay se lau hon nguoi muon, va den cuoi ta van se khong chac chan.',
  'entities.quests.q_spire_reading.title': 'Dieu Thu Tich Khong Chep',
  'entities.quests.q_spire_reading.text': 'Mot lan doc can mot ngon den dung yen va mot trang giay dong bia, ma mua nay dam lay da lay mat ca hai cua ta. To goa phu de dong bia, {playerName}, va mo cua nhung con phinh dam de lam dau. Mang chung den va ta se dat chiec nhan cua nguoi doi chieu voi chinh Thu Tich.',
  ...
  'hudChrome.ring.path.restore': 'Phuc Hoi',
  'hudChrome.ring.path.merge': 'Hop Nhat',
  'hudChrome.ring.path.chaos': 'Hon Loan',
  'hudChrome.ring.preview.restore': 'Chiec nhan tra lai nhung gi bi lay di.',
  'hudChrome.ring.preview.merge': 'Chiec nhan giu lai nhung gi no lay.',
  'hudChrome.ring.preview.chaos': 'Chiec nhan tu quyet dinh. Chua ai nghi den viec hoi no tai sao.',
  'hudChrome.ring.permanent': 'Dieu nay khong the hoan tac.',
  'entities.quests.q_spire_attunement.title': 'Chiec nhan se tro thanh gi',
  'entities.quests.q_spire_attunement.text': 'Ta khong the noi cho nguoi biet chiec nhan cua nguoi la gi, {playerName}. Ta chi co the noi rang no dang lang nghe, va no da cho doi duoc nghe noi. Vay hay noi voi no. Hay chon, va giu lay lua chon do: phuc hoi, va no tra lai nhung gi bi lay di; hop nhat, va no giu lai nhung gi no lay; hoac trao quyen chon cho chinh chiec nhan, roi xem no bien nguoi thanh gi. Ta se khong the hoan tac dieu nay. Nguoi cung vay.',
  'entities.quests.q_spire_attunement.completion': 'No da an dinh. Truoc khi nguoi di len con duong dap, no la gi cung khong con quan trong nua. Hay di can trong, {playerName}. Gio no da biet ten nguoi, va khong phai ta noi cho no.',
};
