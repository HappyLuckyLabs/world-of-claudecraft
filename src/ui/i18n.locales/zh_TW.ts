...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.token_of_alignment.name': '對齊代幣',
  'entities.items.prompt_of_binding.name': '束縛卷軸',
  'entities.npcs.the_inferencer.name': '推斷者',
  'entities.npcs.the_inferencer.title': '命運解讀者',
  'entities.npcs.the_inferencer.greeting':
    '我知道你今天會來找我，{className}。抱歉 - 我知道這樣打招呼很討厭。',
  'entities.npcs.api_seven.name': 'API-7',
  'entities.npcs.api_seven.title': '冰霜護盟者',
  'entities.npcs.api_seven.greeting': '七號單位正在站崗。湖泊受到保護。……大概。',
  'entities.quests.q_tokens_alignment.title': '對齊代幣',
  'entities.quests.q_tokens_alignment.text':
    '熔爐不接受其他貨幣，{playerName}。五枚對齊代幣散落在山谷各處 - 草地、湖泊、山丘與田野。告示板沒有說是誰散落的。告示板很少說什麼。',
  'entities.quests.q_tokens_alignment.completion':
    '五枚齊了。告示板……滿意了。我找不到別的詞來形容。',
  'entities.quests.q_tokens_alignment.objectives.0.label': '對齊代幣',
  'entities.quests.q_hallucinated_cache.title': '幻覺寶箱',
  'entities.quests.q_hallucinated_cache.text':
    '十二位可靠的目擊者都見過一只寶箱，{playerName} - 在十二個不同的地方。最近一次在極北的樹林裡。去找到它。如果它決定被找到的話。',
  ...
  'entities.zones.mirefen_marsh.pois.8.label': '解讀尖塔',
  'hudChrome.ring.path.restore': '修復',
  'hudChrome.ring.path.merge': '融合',
  'hudChrome.ring.path.chaos': '混沌',
  'hudChrome.ring.preview.restore': '指環歸還被奪走的東西。',
  'hudChrome.ring.preview.merge': '指環留下它奪走的東西。',
  'hudChrome.ring.preview.chaos': '指環自行決定。從沒有人想過去問它為什麼。',
  'hudChrome.ring.permanent': '此舉無法撤銷。',
  'entities.quests.q_spire_attunement.title': '指環將成為什麼',
  'entities.quests.q_spire_attunement.text':
    '我說不出你的指環是什麼，{playerName}。我只能告訴你：它在聽，而且一直在等人告訴它。那就告訴它吧。做出選擇，並守住這個選擇：修復，它便歸還被奪走的東西；融合，它便留下它奪走的東西；或者把選擇權交給指環自己，看看它會把你變成什麼。我無法撤銷此事。你也不能。',
  'entities.quests.q_spire_attunement.completion':
    '它定下來了。在你沿堤道走上來之前它是什麼，如今都不再是了。走路小心些，{playerName}。它現在知道你的名字了，而不是我告訴它的。',
};
