...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting': '我知道你今天會來找我，{className}。抱歉 - 我知道這樣打招呼很討厭。',
  ...
  'entities.quests.q_tokens_alignment.text': '熔爐不接受其他貨幣，{playerName}。五枚對齊代幣散落在山谷各處 - 草地、湖泊、山丘與田野。告示板沒有說是誰散落的。告示板很少說什麼。',
  'entities.quests.q_tokens_alignment.completion': '五枚齊了。告示板……滿意了。我找不到別的詞來形容。',
  'entities.quests.q_tokens_alignment.objectives.0.label': '對齊代幣',
  'entities.quests.q_hallucinated_cache.title': '幻覺寶箱',
  'entities.quests.q_hallucinated_cache.text': '十二位可靠的目擊者都見過一只寶箱，{playerName} - 在十二個不同的地方。最近一次在極北的樹林裡。去找到它。如果它決定被找到的話。',
  'entities.quests.q_hallucinated_cache.completion': '它終究讓自己被找到了。留著裡面的卷軸吧。換作是我，不會太常讀它。',
