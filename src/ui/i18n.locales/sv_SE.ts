...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting':
    'Jag visste att du skulle komma i dag, {className}. Forlat - jag vet att det ar ett irriterande satt att halsa.',
  ...
  'entities.quests.q_tokens_alignment.text':
    'Smedjan tar inte emot nagon annan valuta, {playerName}. Fem Riktningstecken ligger utspridda i dalen - ang, sjo, kulle och faelt. Tavlan sager inte vem som spred dem. Tavlan sager sallan nagot.',
  'entities.quests.q_tokens_alignment.completion':
    'Fem av fem. Tavlan ar... nojd. Jag har inget annat ord for det.',
  ...
  'entities.quests.q_hallucinated_cache.text':
    'En skattkista har setts av ett dussin palitliga vittnen, {playerName} - pa ett dussin olika platser. Senast i skogarna langt norrut. Hitta den. Om den bestammer sig for att lata sig hittas.',
