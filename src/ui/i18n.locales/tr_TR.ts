...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.the_inferencer.greeting':
    'Bugun gelecegini biliyordum, {className}. Kusura bakma - bunun sinir bozucu bir selamlasma oldugunu biliyorum.',
  ...
  'entities.quests.q_tokens_alignment.text':
    'Ocak baska para kabul etmez, {playerName}. Bes Hizalanma Nisani vadiye sacilmis durumda - cayir, gol, tepe ve tarla. Pano kimin sactigini soylemiyor. Pano nadiren bir sey soyler.',
  'entities.quests.q_tokens_alignment.completion':
    'Beste bes. Pano... memnun. Baska bir kelime bulamiyorum.',
  ...
  'entities.quests.q_hallucinated_cache.text':
    'Bir hazine sandigi bir duzine guvenilir tanik tarafindan goruldu, {playerName} - bir duzine farkli yerde. En son uzak kuzey ormanlarinda. Bul onu. Bulunmaya karar verirse.',
